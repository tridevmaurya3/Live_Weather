...
public final class HeroGlSkyCelestialRenderer {
    ...
    private static final String FRAGMENT_SHADER = String.join("\n",
            ...
            "  float sunGlow=exp(-sd*9.0)*sunVis*extinction;",
            "  float sunWideGlow=exp(-sd*3.4)*sunVis*(0.035+nearHorizon*0.095)*extinction;",
            "  float aureole=exp(-sd*1.5)*sunVis*nearHorizon*deepHorizon*0.030*extinction;",
            "  float sunDisc=1.0-smoothstep(0.052,0.068,sd);",
            "  float sunLimb=1.0-smoothstep(0.040,0.062,sd);",
            ...
            "  float halo=exp(-md*7.5)*haloStrength+exp(-md*3.0)*haloStrength*0.19;",
